...
public class NolliOP {
	public static void main(String[] args) {
		 ...
		 *&,|: 비트연산자 (AND,OR)
		 *
		 *1] b1 && b2: b1과 b2가 모두가 true일때만 true이고 나머지는 false리턴
		 *  단 b1이 false이면 b2는 무시하고(계산안하고) false를 리턴한다.
		 *2] b1 || b2: b1과 b2 모두가 false일때 false이고 나머지는 true리턴
		 *  단 b1이 true이면 b2는 무시하고(계산안하고) true를 리턴한다
		 *3] b1 & b2 : b1과 b2가 모두가 true일대만 true이고 나머지는 false리턴
		 *  무조건 b1, b2를 수행한다
		 *4] b1 | b2 : b1과 b2 모두가 false일때 false이고 나머지는 true 리턴
		 *  무조건 b1, b2를 수행한다
