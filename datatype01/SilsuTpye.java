...
public class SilsuTpye {
	...
	public static void main(String[] args)	{
		...
		//long = in+f1;
		//long = in+f1;[x] long형과 float형 연산결과는 float
		//float f1= in + f1
	    System.out.println(f1);
		
		/*규칙2]실수형에서 기본 데아티 타입은 double이다
		소수점이붙으면 무조건 double형으로 인식
	    ...
	    */
	    ...
	    /* 문]
	      반지름이 10인 원의 면적을 구해라
	      단 면적을 저장하는 변수의 타입을 3가지 형대(int/float/double)의
	    ...
	    farea = radius*radius*(float)pi; //(float)(radius*radius*3.14)
	    darea = radius*radius*pi;
	    System.out.println("iarea:"+iarea);
	    System.out.println("iarea:"+farea);
	    System.out.println("iarea:"+darea);
