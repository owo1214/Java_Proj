...
public class EscapeChar {
	 ...
	 * %나 %d등의 변환 지시어(Conversion Specifier)를
	 * 사용해서 원하는 출력 형식을 만들 수 있다.
	 * *변환지시어를 쓸 수 있는 메소드가 정해져 있다
	 * 
	 */
	/*주요 변환 지시어
	 * %d: 정수값 출력시(byte/short/ing/long)
	...
	//System.out.printlf("국어:%d,영어:%d,수학:%d,평균%f",kor,eng,math,avg);
	...
	System.out.println("======================================");
	System.out.printf("%-10s%-12s%s%n","KOREA","ENGLISH","MATH","평균");
	System.out.println("======================================");
	System.out.printf("%-10s%-12s%s%n",kor,eng,math,(kor+eng+math)/3);
	System.out.printf("%-10s%-12s%s%n",100,90,77,(100+90+77)/3.0);
	...
	System.out.println("======================================");
	System.out.printf("%-6d%-6d%-6d%-6d%-7d%.1f%n","HONG","95","70","90",95+70+90,(95+70+90)/3.0);
	System.out.printf("%-6d%-6d%-6d%-6d%-7d%.1f%n","KIM","90","85","80",90+85+80,(80+85+80)/3.0);
	System.out.printf("%-6d%-6d%-6d%-6d%-7d%.2f%n","PARK","85","98","97",85+98+97,(85+98+97)/3.0);
