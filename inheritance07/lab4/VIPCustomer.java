...
public class VIPCustomer extends Customer{
	...
	double saleRatio; 		//물품의 할인률, VIP 고객에게만 적용
	...
	public VIPCustomer (int customerID, String customerName, int agentID) {
		super (customerID,customerName);			//super : 부모 클래스의 생성자를 호출
		customerGrade = "VIP";
		bonusRatio =0.05;
		saleRatio = 0.1;
		this.agentID = agentID;
	}
	public int calcPrice (int price) { // 메소드 오버라이딩 : 상속 관계에서 슈퍼(부모) 클래스의 메소드를 재정리해서 사용 
