...
public class CustomerTest1 { // 기본 생성자 호출 setter를 통해서 값을 넣고 출력 
	...
	public static void main(String[] args) {
		Customer customerLee = new Customer();		// 부모 객체를 생성 , 기본 생성자 호출 (등급 sliver)
		customerLee.setCustormerID(10010);
		...
		customerKim.setCustormerID(10020);					//부모클래스의 메소드
		customerKim.setCustomerName("김유신"); 				//부모클래스의 메소드
		customerKim.bonusPoint = 1000;						//부모클래스의 메소드
		System.out.println(customerKim.showCustomerInfo());	//부모클래스의 메소드
