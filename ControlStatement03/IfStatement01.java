...
public class IfStatement01 {
	...
	public static void main(String[] args) throws IOException {
		...
		/* 3-1]
		 * 수행할 명령문이 여러개인경우 {}을 생락하면
		 * 의도하지 않은 결과를 초래할 수 있다.
		 * 그러므로 조건식이 참일대 수행할 명령문이 여러개인 경우는 반드시 {}로 묶어라
		 */
		num1=9;
		if(num1%2 !=0) {
			System.out.printf("num1은 %d이다%n",num1);
			System.out.printf("%d은 홀수이다%n",num1);
		}
		/*
		 * system.in.read()메소드:
		 * 	사용자 입력을 받을때까지
		...
		if(word%2!=0) System.out.println("2의 배수가 아닙니다.");
		}
