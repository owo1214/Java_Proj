...
public class SwitchStatement {
	...
	public static void main(String[] args) throws IOException {
		/*
		 * switch 문: if 문처럼 조건에 따라서 분기하는 제어문
		 * 
		 * 형식:
		 * 
		 * 정수식(산술식):연산의 결과값이 byte/short/int/char/String타입/enum 타입으로
		 * 	나오는 식 long형은 안됨
		...
		//switch문에는 정수식 즉 결과값이 byte/short/int/char/String타입/enum 타입만 허용
		//boolean값은 불가 즉 비교식이나 논리식 사용할 수 없다.
		//switch(inputNumber%3==0) {} //[x] 논리값은 안된다.
		byte b=3;
		switch(b) {
			case 1:
